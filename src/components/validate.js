export const emailValidate = (values, setErrorUnderlineClass, className) => {
  let errors = '';
  const regex =
  ...
  if (errors !== '') {
    setErrorUnderlineClass(className);
  }
  return errors;
};

export const passwordValidate = (values, setErrorUnderlineClass, className) => {
  let errors = '';
